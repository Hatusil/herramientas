...
def analyze_sentiment(text: str, **kwargs) -> Dict[str, Any]:
    ...
    Returns:
        Dict con 'success', 'polarity' (float), 'subjectivity' (float), 
...
def analyze_entities(text: str, **kwargs) -> Dict[str, Any]:
    ...
    Detecta: emails, URLs, fechas, números de teléfono, nombres propios (capitalizados).
...
def analyze_category(text: str, **kwargs) -> Dict[str, Any]:
    ...
    Returns:
        Dict con 'success', 'category' (str), 'confidence' (float), 'features' (dict)
    """
    if not text or not text.strip():
        return {'success': False, 'error': 'Texto vacío'}
...
def analyze_summary(text: str, n_sentences: int = 5, **kwargs) -> Dict[str, Any]:
    ...
    Selecciona las oraciones más importantes basándose en la frecuencia
    de palabras significativas en el texto.
    
    Args:
        text: Texto de entrada
        n_sentences: Número de oraciones en el resumen (default: 5)
        **kwargs: Argumentos adicionales (ignorado)
        
    Returns:
        Dict con 'success', 'summary' (str), 'original_sentences' (int), 
